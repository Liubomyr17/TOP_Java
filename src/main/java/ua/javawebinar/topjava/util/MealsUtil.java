...
public class MealsUtil {
   ...
   public static void main(String[] args) {
       ...
       List<MealTo> mealsWithExcess = getFilteredWithExcess(meals,
       ...
       Map<LocalDate, Integer> caloriesSumByDate = meals.stream().collect(
       ...
       public static List<MealTo>getFilteredWithExcessByCycle(List<Meal> meals,
                                                              LocalTime startTime,
                                                              LocalTime endTime,
                                                              int caloriesPerDay) {
       ...
       public static List<MealTo> getFilteredWithExcessInOnePass(List<Meal> meals,
                                                                 LocalTime startTime,
                                                                 LocalTime endTime,
                                                                 int caloriesPerDay) {
       ...
       return list.stream().flatMap(dayMeals -> {
           boolean excess =
                   dayMeals.stream().mapToInt(Meal::getCalories).sum() > caloriesPerDay;
       ...
       public static List<MealTo> getFilteredWithExcessInOnePass2(List<Meal> meals,
                                                                  LocalTime startTime,
                                                                  LocalTime endTime,
                                                                  int caloriesPerDay) {
